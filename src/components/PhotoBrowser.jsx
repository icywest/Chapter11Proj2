...
export default function PhotoBrowser({ photos, loading, error, onSave, onAddFavorite }) {
  ...
  return (
    <Layout>
      <div>
        <PhotoList photos={photos} onThumbClick={onThumbClick} onAddFavorite={onAddFavorite} />
      </div>
      <div>
        <EditPhotoForm
          photo={selectedPhoto}
